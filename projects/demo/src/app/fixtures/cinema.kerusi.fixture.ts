...
export const CINEMA_MAP: KerusiMap = {
  ...
  locale: 'en',
  legend: [
    { id: 'standard', label: { en: 'Standard', ms: 'Biasa' }, color: '#3a8f63', defaultPriceTier: 'regular' },
    { id: 'premium', label: { en: 'Premium', ms: 'Premium' }, color: '#2f6f9f', defaultPriceTier: 'premium' },
    { id: 'sofa', label: { en: 'Love seat', ms: 'Kerusi Berdua' }, color: '#9a5fa8', defaultPriceTier: 'sofa' },
    { id: 'wheelchair', label: { en: 'Wheelchair space', ms: 'Ruang Kerusi Roda' }, color: '#c78a2e', defaultPriceTier: 'regular' },
  ],
  priceTiers: [
  ...
  sections: [
    {
      ...
      seats: [
        ...
        { id: 'L1', label: '1', row: 'L', x: 28, y: 90, rotation: -10, type: 'sofa', companions: ['L2'] },
        { id: 'L2', label: '2', row: 'L', x: 36, y: 89, rotation: -6, type: 'sofa', companions: ['L1'] },
        { id: 'L3', label: '3', row: 'L', x: 46, y: 88, rotation: -2, type: 'sofa', companions: ['L4'] },
        { id: 'L4', label: '4', row: 'L', x: 54, y: 88, rotation: 2, type: 'sofa', companions: ['L3'] },
        { id: 'L5', label: '5', row: 'L', x: 64, y: 89, rotation: 6, type: 'sofa', companions: ['L6'] },
        { id: 'L6', label: '6', row: 'L', x: 72, y: 90, rotation: 10, type: 'sofa', companions: ['L5'] },
      ],
    },
  ],
};
